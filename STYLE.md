...
*Style guide · July 2026 · Status: living document.*

The documents in this repo aim to follow these guidelines, and contributions (see `CONTRIBUTING.md`) should too. The guide is written to be handed to a language model: if you use LLMs in your writing process, provide them with this file so that they write in the house style. The guidelines are distilled from Halmos, Knuth, Tao, Thurston, and Zagier, and from the practice of the documents in this repository. When guidelines collide, the reader wins.

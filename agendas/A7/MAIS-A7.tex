...
\noindent Provenance and audit record: \url{https://github.com/lionellevine/MAIS/blob/main/agendas/MAIS-A7/PROVENANCE.md}.
...
\begin{conjecture}[\texttt{MAIS-O7}: opposing staircases]\label{conj:opposing}

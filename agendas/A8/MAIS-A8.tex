...
\noindent Provenance and audit record: \url{https://github.com/lionellevine/MAIS/blob/main/agendas/MAIS-A8/PROVENANCE.md}.
...
\begin{problem}[\texttt{MAIS-O8}: The selection map]\label{prob:selectionmap}
...
\begin{problem}[\texttt{MAIS-O8}, $\varepsilon>0$: Diversity at the level of networks]\label{prob:diversitynets}
...
\begin{problem}[\texttt{MAIS-O84}: The crossover time, or: why $2\%$?]\label{prob:crossover}
...
\begin{problem}[\texttt{MAIS-O84}: The crossover asymptotics]

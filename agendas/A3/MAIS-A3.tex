...
\noindent Provenance and audit record: \url{https://github.com/lionellevine/MAIS/blob/main/agendas/MAIS-A3/PROVENANCE.md}.
...
\begin{problem}[\texttt{MAIS-O3}: Identifiability of the $\ell^1$ dictionary estimator]\label{prob:main}

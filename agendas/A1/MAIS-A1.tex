...
\noindent Provenance and audit record: \url{https://github.com/lionellevine/MAIS/blob/main/agendas/A1/PROVENANCE.md}.
...
\begin{problem}[\texttt{MAIS-O1}: Determine the overhead]
...
\bibitem{sol2026}
GPT 5.6 Sol,
\emph{A representation-sensitive refutation and repair of Critch's PBL theorem, with an application to program cooperation},
research note MAIS-P2, July 2026.
\url{https://github.com/lionellevine/MAIS/blob/main/papers/P2/MAIS-P2.pdf}

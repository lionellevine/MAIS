...
\noindent Provenance and audit record: \url{https://github.com/lionellevine/MAIS/blob/main/agendas/MAIS-A2/PROVENANCE.md}.
...
\begin{problem}[\texttt{MAIS-O2}: Query complexity from sampled actions]\label{prob:noisy}

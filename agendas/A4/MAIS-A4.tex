...
\noindent Provenance and audit record: \url{https://github.com/lionellevine/MAIS/blob/main/agendas/MAIS-A4/PROVENANCE.md}.
...
\begin{problem}[\texttt{MAIS-O4}: Coherence-constrained frontier]\label{prob:frontier}
...
\begin{example}[\texttt{MAIS-O51}: The regularized phase diagram of the smallest model]\label{ex:21}

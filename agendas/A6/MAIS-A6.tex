...
\noindent Provenance and audit record: \url{https://github.com/lionellevine/MAIS/blob/main/agendas/MAIS-A6/PROVENANCE.md}.
...
\begin{conjecture}[\texttt{MAIS-O6}: Fourier structure of the most degenerate solutions]\label{conj:fourier}

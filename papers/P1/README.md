...
Eight of the survey's open problems are expanded into the research agendas [MAIS-A1–A8](../../agendas/); all of its problems are indexed in the [problem registry](../../open-problems/).

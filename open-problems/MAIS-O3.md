...
*Open problem MAIS-O3 · headline problem 3 of the survey [MAIS-P1](../papers/P1/MAIS-P1.pdf) · canonically formalized in [MAIS-A3](../agendas/A3/MAIS-A3.pdf) as [Problem 4.3](../agendas/A3/MAIS-A3.tex#L226) · Status: open.*
...
For the precise model and estimator definitions and the two bracketing propositions, see [MAIS-A3](../agendas/A3/MAIS-A3.pdf).

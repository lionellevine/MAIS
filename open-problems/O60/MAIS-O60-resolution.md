...
*Resolved by: Gautam Neelakantan Memana, with a strengthening by GPT 5.6 Sol · Checked by: Claude 5 Fable.*
...
**Full details** can be found in the attachments to [issue #1](https://github.com/lionellevine/MAIS/issues/1). The proofs were independently verified by Claude 5 Fable, and the constructions reproduce numerically.

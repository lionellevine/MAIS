...
- J. Hu and K. Huang, *Global identifiability of $\ell^1$-based dictionary learning via matrix volume optimization*, Advances in Neural Information Processing Systems 36 (2023), 36165–36186.
- Y. Sun and K. Huang, *Global identifiability of overcomplete dictionary learning via $\ell^1$ and volume minimization*, International Conference on Learning Representations (ICLR) 2025.

...
**Problem ([MAIS-A7, Problem 3.9](../agendas/A7/MAIS-A7.tex#L358); λ-stratification of the fiber and its saddles).** For the loss $L(A,B) = \tfrac12 \| BA - \Phi \|_F^2$ with $H > r$:

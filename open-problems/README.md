...
Problems listed here are open unless their row says otherwise — where "open" means open to our knowledge: each problem was checked against the literature when it was released, but no such search is complete, and finding an existing solution counts as [resolving the problem](../CONTRIBUTING.md#substantial-contributions). First resolution: MAIS-O60, resolved in the negative in August 2026 — nine days after the registry launched. Have you [solved one of them](../contributing/solutions.md)? Have a [promising line of attack](../contributing/discussion.md)? Want to [correct a problem statement](../contributing/corrections.md)? Or [propose a problem of your own](../contributing/new-problems.md)?

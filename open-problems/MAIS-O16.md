...
In a **program game**, each player is an algorithm handed the other's source code before choosing its action; the game here is the Prisoner's Dilemma, where between opaque players mutual defection is the unique equilibrium. Critch's bounded agent [[C19]](https://arxiv.org/abs/1602.04184) is

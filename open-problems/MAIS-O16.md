...
In a **program game**, each player is an algorithm handed the other's source code before choosing its action; the game here is the Prisoner's Dilemma, where between opaque players mutual defection is the unique equilibrium. Critch's bounded agent [[C19]](../references/C19.md) is
